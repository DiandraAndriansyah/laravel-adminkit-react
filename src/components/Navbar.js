  ...
  return (
    <nav className="navbar navbar-expand navbar-light navbar-bg">
          ...
          <i className="hamburger align-self-center"></i>
                ...
                <img src="adminkit/img/avatars/avatar.jpg" className="avatar img-fluid rounded me-1" alt="Diandra Like Elaina" /> <span className="text-dark">Diandra Like Elaina</span>
              </a>
